...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_question_decks_id"), "question_decks", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_question_decks_deck_id"), "question_decks", ["deck_id"], unique=True
    )
    op.create_index(
        op.f("ix_question_decks_member_id"),
        "question_decks",
        ["member_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "estimated_time_minutes", sa.Integer(), nullable=False, server_default="2"
        ),
        ...
        sa.Column(
            "related_profile_fields", postgresql.ARRAY(sa.String()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "led_to_suggestion", sa.Boolean(), nullable=False, server_default="false"
        ),
    ...
    op.create_index(
        op.f("ix_question_responses_id"), "question_responses", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_question_responses_session_id"),
        "question_responses",
        ["session_id"],
        unique=False,
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(
        op.f("ix_question_responses_session_id"), table_name="question_responses"
    )
