...
- [ ] When they visit the Profile Optimizer
- [ ] Then they see a "Profile Health" score (0-100%)
- [ ] And they see a visual indicator (progress bar or similar)
- [ ] And they see a list of missing or incomplete fields

### Given a member's profile is incomplete
- [ ] When they view their profile health
- [ ] Then missing fields are clearly identified
- [ ] And optional vs required fields are distinguished
- [ ] And the completeness percentage reflects actual gaps

### Given a member's profile is 100% complete
- [ ] When they view their profile health
- [ ] Then they see a success message
- [ ] And they're encouraged to keep it up-to-date
...
1. Backend: Profile evaluation logic (`agents/profile_evaluation.py`)
2. Backend: API endpoint for evaluation
3. Frontend: Profile Health component with progress bar
4. Frontend: Missing fields list display
